...
#ifndef NhitPionBiggerCell_h
#define NhitPionBiggerCell_h
...
class NhitPionBiggerCell {
 public :
  ...
  std::vector<int> nhit4;
  std::vector<int> nhit5;
  ...
  NhitPionBiggerCell(const char* input);
  virtual ~NhitPionBiggerCell();
...
#ifdef NhitPionBiggerCell_cxx
NhitPionBiggerCell::NhitPionBiggerCell(const char*input) : fChain(0) 
{
...
NhitPionBiggerCell::~NhitPionBiggerCell()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t NhitPionBiggerCell::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t NhitPionBiggerCell::LoadTree(Long64_t entry)
{
...
void NhitPionBiggerCell::Init(TTree *tree)
{
  ...
  fChain->SetBranchAddress("Nhit2by2", &Nhit2by2, &b_Nhit2by2);
  fChain->SetBranchAddress("Nhit3by3", &Nhit3by3, &b_Nhit3by3);
  fChain->SetBranchAddress("Nhit4by4", &Nhit4by4, &b_Nhit4by4);
  fChain->SetBranchAddress("Nhit5by5", &Nhit5by5, &b_Nhit5by5);
  Notify();
}

Bool_t NhitPionBiggerCell::Notify()
{
...
void NhitPionBiggerCell::Show(Long64_t entry)
{
...
Int_t NhitPionBiggerCell::Cut(Long64_t entry)
{
...
int Xmin2(int E)
{
  ...
  else if(E==50) return 50;
  else if(E==60) return 50;
  else if(E==70) return 50;
  else if(E==80) return 50;
  else
...
{
  if(E==5) return 140;
  else if(E==10) return 220;
  else if(E==15) return 270;
  else if(E==20) return 360;
  else if(E==25) return 400;
  else if(E==30) return 460;
  else if(E==40) return 600;
  else if(E==50) return 700;
  else if(E==60) return 800;
  else if(E==70) return 900;
  else if(E==80) return 1000;
  else
    std::cout << "Energy = " << E << " GeV IS NOT A CORRECT ENERGY" << std::endl;
  return 0;
}
...
{
  if(E==5) return 120;
  else if(E==10) return 180;
  else if(E==15) return 230;
  else if(E==20) return 300;
  else if(E==25) return 350;
  else if(E==30) return 400;
  else if(E==40) return 500;
  else if(E==50) return 550;
  else if(E==60) return 650;
  else if(E==70) return 700;
  else if(E==80) return 800;
  else
    std::cout << "Energy = " << E << " GeV IS NOT A CORRECT ENERGY" << std::endl;
  return 0;
}
...
{
  if(E==5) return 110;
  else if(E==10) return 160;
  else if(E==15) return 210;
  else if(E==20) return 250;
  else if(E==25) return 300;
  else if(E==30) return 350;
  else if(E==40) return 400;
  else if(E==50) return 450;
  else if(E==60) return 550;
  else if(E==70) return 600;
  else if(E==80) return 650;
  else
    std::cout << "Energy = " << E << " GeV IS NOT A CORRECT ENERGY" << std::endl;
  return 0;
}
...
int Xmax5(int E)
{
  ...
  else if(E==15) return 200;
  else if(E==20) return 230;
  else if(E==25) return 260;
  else if(E==30) return 300;
  else if(E==40) return 350;
  else if(E==50) return 400;
  else if(E==60) return 500;
  else if(E==70) return 550;
  else if(E==80) return 600;
  else
    std::cout << "Energy = " << E << " GeV IS NOT A CORRECT ENERGY" << std::endl;
  return 0;
}
...
#endif // #ifdef NhitPionBiggerCell_cxx
