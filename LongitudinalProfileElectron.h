...
#ifndef LongitudinalProfileElectron_h
#define LongitudinalProfileElectron_h
...
struct LongitudinalCalibration{
  int layer;
  float coeff0;
  float coeff1;
  float coeff2;
...
class LongitudinalProfileElectron {
 public :
  ...
  std::vector<longiProfile> longiVec;
  ...
  LongitudinalProfileElectron(const char* input);
  virtual ~LongitudinalProfileElectron();
...
#ifdef LongitudinalProfileElectron_cxx
LongitudinalProfileElectron::LongitudinalProfileElectron(const char*input) : fChain(0) 
{
...
LongitudinalProfileElectron::~LongitudinalProfileElectron()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t LongitudinalProfileElectron::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t LongitudinalProfileElectron::LoadTree(Long64_t entry)
{
...
void LongitudinalProfileElectron::Init(TTree *tree)
{
...
Bool_t LongitudinalProfileElectron::Notify()
{
...
void LongitudinalProfileElectron::Show(Long64_t entry)
{
...
Int_t LongitudinalProfileElectron::Cut(Long64_t entry)
{
...
#endif // #ifdef LongitudinalProfileElectron_cxx
