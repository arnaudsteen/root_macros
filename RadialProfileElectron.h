...
#ifndef RadialProfileElectron_h
#define RadialProfileElectron_h
...
class RadialProfileElectron {
 public :
  ...
  RadialProfileElectron(const char* input);
  virtual ~RadialProfileElectron();
...
#ifdef RadialProfileElectron_cxx
RadialProfileElectron::RadialProfileElectron(const char*input) : fChain(0) 
{
...
RadialProfileElectron::~RadialProfileElectron()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t RadialProfileElectron::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t RadialProfileElectron::LoadTree(Long64_t entry)
{
...
void RadialProfileElectron::Init(TTree *tree)
{
...
Bool_t RadialProfileElectron::Notify()
{
...
void RadialProfileElectron::Show(Long64_t entry)
{
...
Int_t RadialProfileElectron::Cut(Long64_t entry)
{
...
#endif // #ifdef RadialProfileElectron_cxx
