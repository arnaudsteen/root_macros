...
#ifndef LongitudinalProfilePion_h
#define LongitudinalProfilePion_h
...
class LongitudinalProfilePion {
 public :
  ...
  LongitudinalProfilePion(const char* input);
  virtual ~LongitudinalProfilePion();
...
#ifdef LongitudinalProfilePion_cxx
LongitudinalProfilePion::LongitudinalProfilePion(const char*input) : fChain(0) 
{
...
LongitudinalProfilePion::~LongitudinalProfilePion()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t LongitudinalProfilePion::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t LongitudinalProfilePion::LoadTree(Long64_t entry)
{
...
void LongitudinalProfilePion::Init(TTree *tree)
{
...
Bool_t LongitudinalProfilePion::Notify()
{
...
void LongitudinalProfilePion::Show(Long64_t entry)
{
...
Int_t LongitudinalProfilePion::Cut(Long64_t entry)
{
...
#endif // #ifdef LongitudinalProfilePion_cxx
