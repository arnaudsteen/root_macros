...
#ifdef NhitPion_cxx
NhitPion::NhitPion(const char*input) : fChain(0) 
{
...
Int_t NhitPion::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t NhitPion::LoadTree(Long64_t entry)
{
...
void NhitPion::Show(Long64_t entry)
{
...
Int_t NhitPion::Cut(Long64_t entry)
{
