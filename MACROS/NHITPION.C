...
void DrawNHIT(bool no_hp=true)
{
  ...
  else entry=leg->AddEntry("Graph1","FTFP_BERT","p");
  ...
  else entry=leg->AddEntry("Graph_Graph2","QGSP_BERT","p");
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHITPIONHP.pdf");
  else
    r1->SaveAs("../plots/NHITPION.pdf");
}
...
void DrawNHIT1(bool no_hp=false)
{
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHIT1PION.pdf");
  else
    r1->SaveAs("../plots/NHIT1PIONHP.pdf");
}
...
void DrawNHIT2(bool no_hp=false)
{
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHIT2PION.pdf");
  else
    r1->SaveAs("../plots/NHIT2PIONHP.pdf");
}
...
void DrawNHIT3(bool no_hp=false)
{
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHIT3PION.pdf");
  else
    r1->SaveAs("../plots/NHIT3PIONHP.pdf");
}
