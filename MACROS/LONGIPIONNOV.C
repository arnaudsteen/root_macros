...
void DrawLONGI()
{
  ...
  std::vector<result> resultData=readTXT(std::string("longiProf_pi-_Nov2012.txt"));
  ...
  r1->cd();
  r1->SetSelected(r1);
  r1->SaveAs("../plots/LONGIPIONNOV.pdf");
}
...
void DrawRMS()
{
  ...
  r1->cd();
  r1->SetSelected(r1);
  r1->SaveAs("../plots/LONGIRMSPIONNOV.pdf");
}
