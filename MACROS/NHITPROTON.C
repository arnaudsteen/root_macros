#include "NHITPROTON.h"

std::vector<result> readTXT(std::string fileName)
{
  std::vector<result> vec;
  char input[200];
  sprintf(input,"%s%s","/home/steen/CBFit/txtFile/",fileName.c_str());
  ...
  float resol;
  while(1){
    in >> ebeam >> nhit >> nhitError >> sigma >> sigmaError >> resol;
    result res;
    res.ebeam=ebeam;
    res.nhit=nhit;
    res.nhitError=nhitError;
    res.sigma=sigma;
...
void DrawNHIT(bool no_hp=false)
{
  //=========Macro generated from canvas: r1/Energy
  //=========  (Fri Apr  6 17:14:48 2012) by ROOT version5.28/00g
  TCanvas *r1;
  if(no_hp) r1 = new TCanvas("r1", "Nhit (hp phys list)",12,24,550,741);
  else r1 = new TCanvas("r1_nohp", "Nhit",12,24,550,741);
  gStyle->SetOptStat(0);
  ...
  std::vector<result> resultData=readTXT(std::string("nhit_augsep2012.txt"));
  ...
  for(unsigned int i=0; i<resultData.size(); i++){
    std::cout << resultData.at(i).ebeam << " " << resultData.at(i).nhit << " " << resultData.at(i).nhitError << std::endl;
  ...
  std::vector<result> resultFTFP;
  if(no_hp)
    resultFTFP=readTXT(std::string("nhit_ftfp_bert_pion.txt"));
  else 
    resultFTFP=readTXT(std::string("nhit_ftfp_bert_hp_pion.txt"));
  ...
  std::vector<result> resultQGSP;
  if(no_hp)
    resultQGSP=readTXT(std::string("nhit_ftfp_bert_proton.txt"));
  else 
    resultQGSP=readTXT(std::string("nhit_ftfp_bert_hp_proton.txt"));
  gre = new TGraphErrors(resultQGSP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kGreen-3);
  gre->SetMarkerColor(kGreen-3);
  gre->SetLineWidth(2);
  ...
  if(no_hp)
    entry=leg->AddEntry("Graph1","pi- FTFP_BERT","p");
  else 
    entry=leg->AddEntry("Graph1","pi- FTFP_BERT_HP","p");
  ...
  if(no_hp)
    entry=leg->AddEntry("Graph_Graph2","proton FTFP_BERT","p");
  else entry=leg->AddEntry("Graph_Graph2","proton FTFP_BERT_HP","p");
  entry->SetLineColor(kGreen-3);
  entry->SetLineStyle(kGreen-3);
  entry->SetLineWidth(kGreen-3);
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHITPROTONHP.pdf");
  else
    r1->SaveAs("../plots/NHITPROTON.pdf");
}


void DrawNHIT1(bool no_hp=false)
{
  //=========Macro generated from canvas: r1/Energy
  //=========  (Fri Apr  6 17:14:48 2012) by ROOT version5.28/00g
  TCanvas *r1;
  if(no_hp) r1 = new TCanvas("r1", "Nhit1 (hp phys list)",12,24,550,741);
  else r1 = new TCanvas("r1_nohp", "Nhit1",12,24,550,741);
  gStyle->SetOptStat(0);
  gStyle->SetOptTitle(0);
  gStyle->SetFrameLineWidth(1);
  r1->Range(0,0,1,1);
  ...
  std::vector<result> resultData=readTXT(std::string("nhit1_augsep2012.txt"));
  TGraphErrors *gre = new TGraphErrors(resultData.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetLineColor(1);
  ...
  std::vector<result> resultFTFP;
  if(no_hp)
    resultFTFP=readTXT(std::string("nhit1_ftfp_bert_proton.txt"));
  else 
    resultFTFP=readTXT(std::string("nhit1_ftfp_bert_hp_proton.txt"));
  gre = new TGraphErrors(resultFTFP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kRed-3);
  ...
  std::vector<result> resultQGSP;
  if(no_hp)
    resultQGSP=readTXT(std::string("nhit1_qgsp_bert_proton.txt"));
  else 
    resultQGSP=readTXT(std::string("nhit1_qgsp_bert_hp_proton.txt"));
  gre = new TGraphErrors(resultQGSP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kGreen-3);
  ...
  hd->GetXaxis()->SetTitleSize(30);
  hd->GetXaxis()->SetTitleOffset(2.);
  hd->GetYaxis()->SetTitle("(#DeltaN_{hit1})/N_{data}");
  hd->GetYaxis()->SetLabelFont(43);
  hd->GetYaxis()->SetLabelSize(20);
  hd->GetYaxis()->SetTitleSize(30);
  hd->GetYaxis()->SetTitleOffset(1.7);
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHIT1PROTON.pdf");
  else
    r1->SaveAs("../plots/NHIT1PROTONHP.pdf");
}

void DrawNHIT2(bool no_hp=false)
{
  //=========Macro generated from canvas: r1/Energy
  //=========  (Fri Apr  6 17:14:48 2012) by ROOT version5.28/00g
  TCanvas *r1;
  if(no_hp) r1 = new TCanvas("r1", "Nhit2 (hp phys list)",12,24,550,741);
  else r1 = new TCanvas("r1_nohp", "Nhit2",12,24,550,741);
  gStyle->SetOptStat(0);
  gStyle->SetOptTitle(0);
  gStyle->SetFrameLineWidth(1);
  r1->Range(0,0,1,1);
  ...
  std::vector<result> resultData=readTXT(std::string("nhit2_augsep2012.txt"));
  TGraphErrors *gre = new TGraphErrors(resultData.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetLineColor(1);
  ...
  std::vector<result> resultFTFP;
  if(no_hp)
    resultFTFP=readTXT(std::string("nhit2_ftfp_bert_proton.txt"));
  else 
    resultFTFP=readTXT(std::string("nhit2_ftfp_bert_hp_proton.txt"));
  gre = new TGraphErrors(resultFTFP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kRed-3);
  ...
  std::vector<result> resultQGSP;
  if(no_hp)
    resultQGSP=readTXT(std::string("nhit2_qgsp_bert_proton.txt"));
  else 
    resultQGSP=readTXT(std::string("nhit2_qgsp_bert_hp_proton.txt"));
  gre = new TGraphErrors(resultQGSP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kGreen-3);
  ...
  hd->GetXaxis()->SetTitleSize(30);
  hd->GetXaxis()->SetTitleOffset(2.);
  hd->GetYaxis()->SetTitle("(#DeltaN_{hit2})/N_{data}");
  hd->GetYaxis()->SetLabelFont(43);
  hd->GetYaxis()->SetLabelSize(20);
  hd->GetYaxis()->SetTitleSize(30);
  hd->GetYaxis()->SetTitleOffset(1.7);
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHIT2PROTON.pdf");
  else
    r1->SaveAs("../plots/NHIT2PROTONHP.pdf");
}

void DrawNHIT3(bool no_hp=false)
{
  //=========Macro generated from canvas: r1/Energy
  //=========  (Fri Apr  6 17:14:48 2012) by ROOT version5.28/00g
  TCanvas *r1;
  if(no_hp) r1 = new TCanvas("r1", "Nhit3 (hp phys list)",12,24,550,741);
  else r1 = new TCanvas("r1_nohp", "Nhit3",12,24,550,741);
  gStyle->SetOptStat(0);
  gStyle->SetOptTitle(0);
  gStyle->SetFrameLineWidth(1);
  r1->Range(0,0,1,1);
  ...
  std::vector<result> resultData=readTXT(std::string("nhit3_augsep2012.txt"));
  TGraphErrors *gre = new TGraphErrors(resultData.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetLineColor(1);
  ...
  std::vector<result> resultFTFP;
  if(no_hp)
    resultFTFP=readTXT(std::string("nhit3_ftfp_bert_proton.txt"));
  else 
    resultFTFP=readTXT(std::string("nhit3_ftfp_bert_hp_proton.txt"));
  gre = new TGraphErrors(resultFTFP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kRed-3);
  ...
  std::vector<result> resultQGSP;
  if(no_hp)
    resultQGSP=readTXT(std::string("nhit3_qgsp_bert_proton.txt"));
  else 
    resultQGSP=readTXT(std::string("nhit3_qgsp_bert_hp_proton.txt"));
  gre = new TGraphErrors(resultQGSP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kGreen-3);
  ...
  hd->GetXaxis()->SetTitleSize(30);
  hd->GetXaxis()->SetTitleOffset(2.);
  hd->GetYaxis()->SetTitle("(#DeltaN_{hit3})/N_{data}");
  hd->GetYaxis()->SetLabelFont(43);
  hd->GetYaxis()->SetLabelSize(20);
  hd->GetYaxis()->SetTitleSize(30);
  hd->GetYaxis()->SetTitleOffset(1.7);
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHIT3PROTON.pdf");
  else
    r1->SaveAs("../plots/NHIT3PROTONHP.pdf");
}
