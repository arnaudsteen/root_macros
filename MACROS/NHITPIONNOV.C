...
void DrawNHIT(bool no_hp)
{
  //=========Macro generated from canvas: r1/Energy
  //=========  (Fri Apr  6 17:14:48 2012) by ROOT version5.28/00g
  TCanvas *r1;
  if(no_hp) r1 = new TCanvas("r1", "Nhit (no hp phys list)",12,24,550,741);
  ...
  std::vector<result> resultData=readTXT(std::string("nhit_nov2012.txt"));
  ...
  if(no_hp)
    resultQGSP=readTXT(std::string("nhit_qgsp_bert_pion.txt"));
  else 
    resultQGSP=readTXT(std::string("nhit_qgsp_bert_hp_pion.txt"));
  ...
  TLegendEntry *entry=leg->AddEntry("Graph_Graph3","SDHCAL DATA (H2 CERN SPS)","p");
  ...
  if(no_hp)
    entry=leg->AddEntry("Graph1","FTFP_BERT","p");
  else 
  ...
  if(no_hp)
    entry=leg->AddEntry("Graph_Graph2","QGSP_BERT","p");
  else entry=leg->AddEntry("Graph_Graph2","QGSP_BERT_HP","p");
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHITPIONNOV.pdf");
  else
    r1->SaveAs("../plots/NHITPIONNOVHP.pdf");
}
...
void DrawNHIT1(bool no_hp=false)
{
  ...
  std::vector<result> resultData=readTXT(std::string("nhit1_nov2012.txt"));
  TGraphErrors *gre = new TGraphErrors(resultData.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetLineColor(1);
  ...
  std::vector<result> resultFTFP;
  if(no_hp)
    resultFTFP=readTXT(std::string("nhit1_ftfp_bert_pion.txt"));
  else 
    resultFTFP=readTXT(std::string("nhit1_ftfp_bert_hp_pion.txt"));
  gre = new TGraphErrors(resultFTFP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kRed-3);
  ...
  std::vector<result> resultQGSP;
  if(no_hp)
    resultQGSP=readTXT(std::string("nhit1_qgsp_bert_pion.txt"));
  else 
    resultQGSP=readTXT(std::string("nhit1_qgsp_bert_hp_pion.txt"));
  gre = new TGraphErrors(resultQGSP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kBlue-6);
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHIT1PIONNOV.pdf");
  else
    r1->SaveAs("../plots/NHIT1PIONNOVHP.pdf");
}
...
void DrawNHIT2(bool no_hp=false)
{
  ...
  std::vector<result> resultData=readTXT(std::string("nhit2_nov2012.txt"));
  TGraphErrors *gre = new TGraphErrors(resultData.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetLineColor(1);
  ...
  std::vector<result> resultFTFP;
  if(no_hp)
    resultFTFP=readTXT(std::string("nhit2_ftfp_bert_pion.txt"));
  else 
    resultFTFP=readTXT(std::string("nhit2_ftfp_bert_hp_pion.txt"));
  gre = new TGraphErrors(resultFTFP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kRed-3);
  ...
  std::vector<result> resultQGSP;
  if(no_hp)
    resultQGSP=readTXT(std::string("nhit2_qgsp_bert_pion.txt"));
  else 
    resultQGSP=readTXT(std::string("nhit2_qgsp_bert_hp_pion.txt"));
  gre = new TGraphErrors(resultQGSP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kBlue-6);
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHIT2PIONNOV.pdf");
  else
    r1->SaveAs("../plots/NHIT2PIONNOVHP.pdf");
}
...
void DrawNHIT3(bool no_hp=false)
{
  ...
  std::vector<result> resultData=readTXT(std::string("nhit3_nov2012.txt"));
  TGraphErrors *gre = new TGraphErrors(resultData.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetLineColor(1);
  ...
  std::vector<result> resultFTFP;
  if(no_hp)
    resultFTFP=readTXT(std::string("nhit3_ftfp_bert_pion.txt"));
  else 
    resultFTFP=readTXT(std::string("nhit3_ftfp_bert_hp_pion.txt"));
  gre = new TGraphErrors(resultFTFP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kRed-3);
  ...
  std::vector<result> resultQGSP;
  if(no_hp)
    resultQGSP=readTXT(std::string("nhit3_qgsp_bert_pion.txt"));
  else 
    resultQGSP=readTXT(std::string("nhit3_qgsp_bert_hp_pion.txt"));
  gre = new TGraphErrors(resultQGSP.size());
  gre->SetName("Graph");
  gre->SetTitle("Graph");
  gre->SetFillColor(kBlue-6);
  ...
  r1->SetSelected(r1);
  if(no_hp)
    r1->SaveAs("../plots/NHIT3PIONNOV.pdf");
  else
    r1->SaveAs("../plots/NHIT3PIONNOVHP.pdf");
}
