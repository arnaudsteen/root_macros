...
#ifndef LinearSimEreco_h
#define LinearSimEreco_h
...
class LinearSimEreco {
 public :
  ...
  LinearSimEreco(const char* input);
  virtual ~LinearSimEreco();
  virtual Int_t    Cut(Long64_t entry);
  virtual Int_t    GetEntry(Long64_t entry);
  virtual Long64_t LoadTree(Long64_t entry);
  virtual void     Init(TTree *tree);
  virtual void     Loop();
  virtual TH1D*    FindLinearErec(int e);
...
#ifdef LinearSimEreco_cxx
LinearSimEreco::LinearSimEreco(const char*input) : fChain(0) 
{
...
LinearSimEreco::~LinearSimEreco()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t LinearSimEreco::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t LinearSimEreco::LoadTree(Long64_t entry)
{
...
void LinearSimEreco::Init(TTree *tree)
{
...
void LinearSimEreco::Show(Long64_t entry)
{
...
Int_t LinearSimEreco::Cut(Long64_t entry)
{
...
#endif // #ifdef LinearSimEreco_cxx
