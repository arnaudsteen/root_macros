...
#ifndef PionTimeCalibration_h
#define PionTimeCalibration_h
...
class PionTimeCalibration {
 public :
  ...
  std::vector<int> nhit2by2;
  std::vector<int> nhit3by3;
  std::vector<int> nhit4by4;
  std::vector<int> nhit5by5;
  ...
  PionTimeCalibration(const char* input);
  virtual ~PionTimeCalibration();
...
#ifdef PionTimeCalibration_cxx
PionTimeCalibration::PionTimeCalibration(const char*input) : fChain(0) 
{
...
PionTimeCalibration::~PionTimeCalibration()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t PionTimeCalibration::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t PionTimeCalibration::LoadTree(Long64_t entry)
{
...
void PionTimeCalibration::Init(TTree *tree)
{
...
Bool_t PionTimeCalibration::Notify()
{
...
void PionTimeCalibration::Show(Long64_t entry)
{
...
Int_t PionTimeCalibration::Cut(Long64_t entry)
{
...
#endif // #ifdef PionTimeCalibration_cxx
